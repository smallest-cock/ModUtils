...
Color::Color(float arr[3]) : R(255), G(255), B(255), A(255) { FromLinear(CoolerLinearColor(arr[0], arr[1], arr[2], 1.0f)); }	// added by mwah
...
class CoolerLinearColor Color::ToLinear() const
{
	return CoolerLinearColor().FromColor(*this);
}
...
CoolerLinearColor::CoolerLinearColor(uint8_t r, uint8_t g, uint8_t b, uint8_t a) : R(1.0f), G(1.0f), B(1.0f), A(1.0f) { FromColor(Color(a, g, b, a)); }

CoolerLinearColor::CoolerLinearColor(const std::string& hexColor) : R(1.0f), G(1.0f), B(1.0f), A(1.0f) { FromHex(hexColor); }

CoolerLinearColor::CoolerLinearColor(const struct FLinearColor& linearColor) : R(linearColor.R), G(linearColor.G), B(linearColor.B), A(linearColor.A) {}

CoolerLinearColor::CoolerLinearColor(const CoolerLinearColor& linearColor) : R(linearColor.R), G(linearColor.G), B(linearColor.B), A(linearColor.A) {}

CoolerLinearColor::~CoolerLinearColor() {}

struct FLinearColor CoolerLinearColor::UnrealColor() const
{
	return FLinearColor{ R, G, B, A };
}

Color CoolerLinearColor::ToColor() const
{
	return Color(R, G, B, A);
}

uint32_t CoolerLinearColor::ToDecimal() const
{
	return ToColor().ToDecimal();
}

uint32_t CoolerLinearColor::ToDecimalAlpha() const
{
	return ToColor().ToDecimalAlpha();
}

std::string CoolerLinearColor::ToHex(bool bNotation) const
{
	return ToColor().ToHex(bNotation);
}

std::string CoolerLinearColor::ToHexAlpha(bool bNotation) const
{
...
CoolerLinearColor& CoolerLinearColor::FromDecimal(uint32_t decimalColor)
{
	return FromColor(Color().FromDecimal(decimalColor));
}

CoolerLinearColor& CoolerLinearColor::FromHex(std::string hexColor)
{
	return FromColor(Color(hexColor));
}

CoolerLinearColor& CoolerLinearColor::Cycle(int32_t steps)
{
...
int32_t GRainbowColor::GetDecimal() {
	return (GetByte().R << 16) + (GetByte().G << 8) + GetByte().B;
}
...
bool GRainbowColor::TickCountIsMultipleOf(int num)
{
	return tickCounter % num == 0;
}
