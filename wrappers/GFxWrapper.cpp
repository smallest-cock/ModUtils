...
{
	set_string(Instances.FindFName(col_name), Instances.NewFString(value));
}
...
{
	set_int(Instances.FindFName(col_name), value);
}
...
{
	set_float(Instances.FindFName(col_name), value);
}
...
{
	set_bool(Instances.FindFName(col_name), value);
}
...
{
	set_texture(Instances.FindFName(col_name), value);
}
...
void GfxWrapper::set_color(const std::string& col_name, const GUI::Colors::Color& value)
{
	...
	datastore->SetASValue(gfx_row->TableName, gfx_row->RowIndex, Instances.FindFName(col_name), val);
}
...
{
	return get_string(Instances.FindFName(col_name));
}
...
{
	return get_int(Instances.FindFName(col_name));
}
...
{
	return get_float(Instances.FindFName(col_name));
}
...
{
	return get_bool(Instances.FindFName(col_name));
}
...
{
	return get_texture(Instances.FindFName(col_name));
}
